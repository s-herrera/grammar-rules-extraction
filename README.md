...
2. Follow this [instructions up to the _Step 3_](https://grew.fr/usage/install/) to install grew and grewpy after running `sudo apt update && sudo apt upgrade` or just run the following lines.
